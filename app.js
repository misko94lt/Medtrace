...
it: {
app_name: "MedTrace",
app_subtitle: "Gestione Apparecchiature Elettromedicali",
app_tagline: "CMMS Elettromedicali",
save: "Salva",
cancel: "Annulla",
delete: "Elimina",
edit: "Modifica",
...
saved: "Salvato",
deleted: "Eliminato",
confirm_delete: "Eliminare questa riga? L'azione non si può annullare.",
optional: "Opzionale",
...
nav_jobs: "Job / Interventi",
nav_iec: "Sicurezza Elettrica",
nav_func: "Verif. Funzionale",
nav_agenda: "Agenda & Scheduling",
nav_instruments: "Strumenti Misura",
nav_procedures: "Procedure",
nav_assets: "Apparecchi",
...
group_assets: "Parco Macchine",
group_warehouse: "Magazzino",
group_admin: "Amministrazione",
group_system: "Sistema",
dashboard_title: "Dashboard",
kpi_assets: "Apparecchi",
kpi_open_jobs: "Job Aperti",
kpi_urgent: "Urgenti",
kpi_quotes_open: "Preventivi Aperti",
kpi_iec_reports: "Verifiche IEC",
kpi_func_reports: "Verifiche Funz.",
kpi_low_stock: "Stock Basso",
kpi_cal_expiring: "Cal. in Scadenza",
kpi_out_of_service: "Fuori Servizio",
revenue_chart: "Ricavi ultimi 6 mesi",
monthly_revenue: "Ricavi mensili",
assets_title: "Apparecchi",
assets_subtitle: "Parco macchine elettromedicali",
asset_new: "Nuovo Apparecchio",
asset_edit: "Modifica Apparecchio",
asset_detail: "Scheda Apparecchio",
asset_name: "Nome apparecchio",
asset_brand: "Marca",
asset_model: "Modello",
asset_serial: "N° Serie",
asset_location: "Ubicazione / Reparto",
asset_customer: "Cliente / Struttura",
asset_status: "Stato",
asset_risk_class: "Classe di rischio",
asset_iec_norm: "Norma applicabile",
asset_last_service: "Ultima manutenzione",
asset_next_service: "Prossima manutenzione",
asset_purchase_date: "Data acquisto",
asset_warranty: "Scadenza garanzia",
asset_notes: "Note",
status_operative: "Operativo",
status_out_of_service: "Fuori servizio",
status_maintenance: "In manutenzione",
tab_scheda: "Scheda",
tab_jobs: "Job",
tab_iec: "Sic. Elettrica",
tab_func: "Funzionale",
tab_procedures: "Procedure",
no_procedures_for_model: "Nessuna procedura per questo modello.",
create_procedure_for: "Crea procedura per",
jobs_title: "Job / Interventi",
job_new: "Nuovo Job",
job_edit: "Modifica Job",
job_id: "ID Job",
job_type: "Tipo intervento",
job_priority: "Priorità",
job_status: "Stato",
job_asset: "Apparecchio",
job_customer: "Cliente",
job_open_date: "Data apertura",
job_close_date: "Data chiusura",
job_assignee: "Assegnato a",
job_description: "Descrizione intervento",
job_notes: "Note tecniche",
job_parts: "Parti utilizzate",
job_labor_hours: "Ore manodopera",
job_labor_rate: "Tariffa oraria (€/h)",
job_timeline: "Timeline",
job_photos: "Foto",
job_new_quote: "Crea Preventivo",
type_ppm: "PPM",
type_repair: "Riparazione",
type_verification: "Verifica",
type_installation: "Installazione",
type_inspection: "Ispezione",
type_other: "Altro",
...
status_waiting_parts: "Attesa parti",
status_closed: "Chiuso",
status_suspended: "Sospeso",
iec_title: "Verifiche Sicurezza Elettrica",
iec_subtitle_62353: "IEC 62353",
iec_subtitle_61010: "IEC 61010-1",
iec_reports: "rapporti",
iec_new: "Nuova verifica",
iec_report_number: "N° Rapporto",
iec_norm: "Norma",
iec_class: "Classe apparecchio",
iec_patient_type: "Tipo parte applicata",
iec_method: "Metodo di misura",
iec_verify_type: "Tipo verifica",
iec_date: "Data verifica",
iec_technician: "Tecnico verificatore",
iec_instrument: "Strumento di misura",
iec_cal_number: "N° Calibrazione strumento",
iec_visual: "Ispezione visiva",
iec_measures: "Misure elettriche",
iec_overall: "Esito complessivo",
iec_pass: "CONFORME",
iec_fail: "NON CONFORME",
method_direct: "Direct method (Diretto) — Cl.I 500µA / Cl.II 100µA",
method_differential: "Differential method (Differenziale) — Cl.I 500µA / Cl.II 100µA",
method_alternative: "Alternative method (Alternativo) — Cl.I 1000µA / Cl.II 500µA",
method_direct_desc: "Direct: actual earth leakage via body model. Standard/protected rooms.",
method_differential_desc: "Differential: L/N imbalance. Safe in all environments including IT-isolated rooms.",
method_alternative_desc: "Alternative: similar to dielectric test, DUT off. Higher limits apply.",
patient_B: "Type B — Body contact (no applied part leakage test)",
patient_BF: "Type BF — Isolated floating applied part (≤ 5000µA)",
patient_CF: "Type CF — Direct cardiac application (≤ 50µA)",
patient_B_desc: "Type B: non-isolated body contact — no applied part leakage test required",
patient_BF_desc: "Type BF: isolated floating applied part (e.g. ECG, SpO2, defibrillator paddles)",
patient_CF_desc: "Type CF: direct cardiac application — very strict limits",
class_I: "Classe I — con PE",
class_II: "Classe II — doppio isolamento",
class_III: "Classe III — SELV",
verify_periodic: "Periodica",
verify_extraordinary: "Straordinaria",
visual_housing: "Involucro / Carcassa",
visual_cable: "Cavo alimentazione",
visual_connectors: "Connettori / accessori",
visual_labels: "Etichette / marcature",
visual_docs: "Documentazione",
visual_ok: "OK",
visual_fail: "Non OK",
visual_na: "N/A",
meas_pe: "Protective earth resistance (PE)",
meas_ins: "Insulation resistance (500 Vdc)",
meas_eq_dir: "Equipment leakage current (Direct/Differential method)",
meas_eq_alt: "Equipment leakage current (Alternative method)",
meas_ap_bf_dir: "Applied part leakage current BF (Direct method)",
meas_ap_bf_alt: "Applied part leakage current BF (Alternative method)",
meas_ap_cf_dir: "Applied part leakage current CF (Direct method)",
meas_ap_cf_alt: "Applied part leakage current CF (Alternative method)",
func_title: "Verifiche Funzionali",
func_new: "Nuova verifica",
func_template: "Template",
func_report_number: "N° Rapporto",
func_date: "Data verifica",
func_technician: "Tecnico verificatore",
func_instrument: "Strumento utilizzato",
func_verify_type: "Tipo verifica",
func_pass: "CONFORME",
func_fail: "NON CONFORME",
func_item_pass: "✓",
func_item_fail: "✗",
func_item_na: "N/A",
func_item_nd: "—",
func_section_na: "N/A Section",
func_section_restore: "↩ Restore",
func_measure_expected: "Expected",
func_measure_value: "Value",
func_measure_unit: "Unit",
func_measure_result: "Result",
instruments_title: "Strumenti di Misura",
instrument_new: "Nuovo Strumento",
instrument_brand: "Marca",
instrument_model: "Modello",
instrument_serial: "N° Serie",
instrument_cal_number: "N° Calibrazione",
instrument_cal_date: "Data calibrazione",
instrument_cal_expiry: "Scadenza calibrazione",
instrument_cal_interval: "Intervallo (mesi)",
instrument_notes: "Note",
instrument_renew: "Rinnova Calibrazione",
cal_status_ok: "Calibrato",
cal_status_expiring: "In scadenza",
cal_status_expired: "Scaduta",
procedures_title: "Procedure Tecniche",
procedures_subtitle: "Guide passo-passo per modello specifico (knowledge base interna)",
procedure_new: "Nuova procedura",
procedure_edit: "Modifica Procedura",
procedure_model: "Modello target",
procedure_brand: "Marca",
procedure_category: "Categoria",
procedure_type: "Tipo procedura",
procedure_time: "Tempo stimato (min)",
procedure_tools: "Strumenti necessari",
procedure_parts: "Ricambi tipici",
procedure_steps: "Passi della procedura",
procedure_notes: "Note e tips",
procedure_step_title: "Titolo passo",
procedure_step_desc: "Descrizione dettagliata",
procedure_step_expected: "Valore atteso",
procedure_step_warning: "Avvertenza",
procedure_step_image: "+ Aggiungi 1 foto (max 3MB)",
procedure_add_step: "+ Aggiungi passo",
procedure_created: "Creata il",
go_to_procedures: "→ Vai a tutte le Procedure",
quotes_title: "Preventivi",
quotes_subtitle: "Quotazioni da job → PDF professionale",
quote_new: "Nuovo preventivo",
quote_number: "N° Preventivo",
quote_date: "Data preventivo",
quote_valid_until: "Valido fino al",
quote_customer: "Cliente",
quote_job: "Job collegato",
quote_status: "Stato",
quote_labor: "Manodopera",
quote_parts: "Parti / Materiali",
quote_subtotal: "Imponibile",
quote_vat: "IVA",
quote_total: "TOTALE",
quote_vat_exempt: "Esente IVA (art. 10, regime forfettario, ecc.)",
quote_payment_terms: "Condizioni di pagamento",
quote_notes: "Note / condizioni speciali",
quote_add_labor: "+ Voce",
quote_add_free_line: "+ Riga libera",
quote_from_warehouse: "Aggiungi dal magazzino (senza scalare stock)",
quote_labor_label: "Descrizione (es. Trasferta, Ore lavoro, Installazione…)",
quote_labor_hours: "ore",
quote_labor_rate: "€/h",
quote_subtotal_labor: "Subtotale manodopera",
quote_subtotal_parts: "Subtotale materiali",
quote_create_from_job: "Crea preventivo",
quote_pdf: "PDF",
status_draft: "Bozza",
status_sent: "Inviato",
...
kpi_quotes_active: "In corso (bozza+inviati)",
kpi_quotes_accepted: "Accettati",
kpi_quotes_value: "Valore inviati",
kpi_quotes_total: "Totale",
customers_title: "Clienti",
customer_new: "Nuovo Cliente",
customer_edit: "Modifica Cliente",
customer_name: "Nome / Ragione sociale",
customer_contact: "Referente",
customer_email: "Email",
customer_phone: "Telefono",
customer_address: "Indirizzo",
customer_vat: "P.IVA / C.F.",
customer_notes: "Note",
parts_title: "Magazzino Ricambi",
part_new: "Nuovo Ricambio",
part_name: "Nome ricambio",
part_code: "Codice / Part Number",
part_brand: "Marca",
part_qty: "Quantità",
part_min_qty: "Scorta minima",
part_unit_price: "Prezzo acquisto (€)",
part_sell_price: "Prezzo vendita (€)",
part_location: "Posizione magazzino",
part_notes: "Note",
part_low_stock: "Stock basso",
part_out_of_stock: "Esaurito",
agenda_title: "Agenda & Scheduling",
agenda_month: "Mese",
agenda_list: "Lista 60gg",
agenda_auto: "Piano Automatico",
agenda_manual: "Piano Manuale",
settings_title: "Impostazioni",
settings_company: "Dati Azienda",
settings_company_name: "Nome azienda",
settings_company_subtitle: "Sottotitolo / specializzazione",
settings_company_address: "Indirizzo",
settings_company_vat: "P.IVA",
settings_company_email: "Email",
settings_company_phone: "Telefono",
settings_backup: "Backup e Ripristino",
settings_export: "⬇ Esporta backup",
settings_import: "⬆ Importa backup",
settings_merge: "⊕ Unisci backup",
settings_reset: "⚠ Reset completo",
settings_storage: "Spazio utilizzato",
settings_portal: "Anteprima Portale Cliente",
settings_portal_open: "👁 Apri anteprima portale",
...
pdf_print: "🖿 Stampa",
pdf_close: "✕ Chiudi",
pdf_preview: "Anteprima documento",
pdf_iec_title: "RAPPORTO DI VERIFICA SICUREZZA ELETTRICA",
pdf_func_title: "RAPPORTO DI VERIFICA FUNZIONALE",
pdf_job_title: "RAPPORTO DI INTERVENTO",
pdf_quote_title: "PREVENTIVO",
pdf_report_number: "N° RAPPORTO",
pdf_date: "Data",
pdf_valid_until: "Valido fino al",
pdf_technician: "TECNICO VERIFICATORE",
pdf_asset: "APPARECCHIO",
pdf_serial: "N° SERIE",
pdf_brand_model: "MARCA / MODELLO",
pdf_location: "UBICAZIONE",
pdf_customer: "CLIENTE",
pdf_norm: "NORMA",
pdf_class: "CLASSE",
pdf_method: "METODO",
pdf_patient_type: "TIPO PARTE",
pdf_visual_inspection: "Ispezione Visiva",
pdf_electrical_measures: "Misure Elettriche",
pdf_measure: "Misura",
pdf_expected: "Limite",
pdf_value: "Valore",
pdf_unit: "U.M.",
...
pdf_fail: "✗ FAIL",
pdf_nd: "N/D",
pdf_overall_pass: "CONFORME",
pdf_overall_fail: "NON CONFORME",
pdf_footer_not_invoice: "Questo documento non ha valore fiscale — per la fatturazione utilizzare il software di fatturazione elettronica",
pdf_generated: "Rapporto generato il",
toast_saved: "✓ Salvato",
toast_deleted: "Eliminato",
toast_pdf_generating: "Generazione PDF in corso…",
toast_backup_exported: "Backup esportato",
toast_backup_imported: "Dati importati correttamente",
toast_backup_merged: "Dati uniti correttamente",
toast_reset_done: "Dati azzerati",
toast_cal_renewed: "Calibrazione rinnovata",
toast_quote_created: "✓ Preventivo creato",
toast_quote_updated: "Preventivo aggiornato",
toast_procedure_saved: "✓ Procedura salvata",
toast_procedure_deleted: "Procedura eliminata",
toast_duplicated: "✓ Duplicato",
portal_title: "Portale Cliente",
portal_banner: "ANTEPRIMA PORTALE CLIENTE (read-only) — questo è quello che vedrà il tuo cliente",
portal_exit: "✕ Esci anteprima",
portal_preview_as: "Anteprima come cliente:",
portal_online: "● ONLINE",
portal_request: "Richiedi intervento",
portal_request_desc: "Segnala un guasto o richiedi una verifica programmata",
portal_request_btn: "+ Nuova richiesta",
portal_tab_jobs: "Interventi",
portal_tab_assets: "Apparecchi",
portal_tab_iec: "Sic. Elettrica",
portal_tab_func: "Funzionali",
portal_no_jobs: "Nessun intervento registrato",
portal_no_assets: "Nessun apparecchio registrato",
portal_no_iec: "Nessuna verifica di sicurezza elettrica",
portal_no_func: "Nessuna verifica funzionale",
portal_no_customers: "Nessun cliente",
portal_footer: "Solo visualizzazione — Per assistenza tecnica contatta il tuo referente",
legal_title: "Legale & Privacy",
},
en: {
app_name: "MedTrace",
app_subtitle: "Medical Equipment Management",
app_tagline: "Biomedical Equipment CMMS",
save: "Save",
cancel: "Cancel",
delete: "Delete",
edit: "Edit",
...
saved: "Saved",
deleted: "Deleted",
confirm_delete: "Delete this row? This action cannot be undone.",
optional: "Optional",
required: "Required",
of: "of",
results: "results",
...
all: "All",
nav_dashboard: "Dashboard",
nav_jobs: "Jobs / Work Orders",
nav_iec: "Electrical Safety",
nav_func: "Functional Testing",
nav_agenda: "Schedule & Calendar",
nav_instruments: "Test Instruments",
nav_procedures: "Procedures",
nav_assets: "Equipment",
...
group_assets: "Assets Management",
group_warehouse: "Warehouse",
group_admin: "Administration",
group_system: "System",
dashboard_title: "Dashboard",
kpi_assets: "Equipment",
kpi_open_jobs: "Open Jobs",
kpi_urgent: "Urgent",
kpi_quotes_open: "Open Quotations",
kpi_iec_reports: "IEC Tests",
kpi_func_reports: "Func. Tests",
kpi_low_stock: "Low Stock",
kpi_cal_expiring: "Cal. Expiring",
kpi_out_of_service: "Out of Service",
revenue_chart: "Revenue last 6 months",
monthly_revenue: "Monthly revenue",
assets_title: "Equipment",
assets_subtitle: "Biomedical equipment fleet",
asset_new: "New Equipment",
asset_edit: "Edit Equipment",
asset_detail: "Equipment Record",
asset_name: "Equipment name",
asset_brand: "Brand",
asset_model: "Model",
asset_serial: "Serial No.",
asset_location: "Location / Department",
asset_customer: "Customer / Facility",
asset_status: "Status",
asset_risk_class: "Risk class",
asset_iec_norm: "Applicable standard",
asset_last_service: "Last service",
asset_next_service: "Next service",
asset_purchase_date: "Purchase date",
asset_warranty: "Warranty expiry",
asset_notes: "Notes",
status_operative: "In Use",
status_out_of_service: "Condemned / Retired",
...
no_procedures_for_model: "No procedures for this model.",
create_procedure_for: "Create procedure for",
jobs_title: "Jobs / Work Orders",
job_new: "New Job",
job_edit: "Edit Job",
job_id: "Job ID",
job_type: "Intervention type",
job_priority: "Priority",
job_status: "Status",
job_asset: "Equipment",
job_customer: "Customer",
job_open_date: "Open date",
job_close_date: "Close date",
job_assignee: "Assigned to",
job_description: "Work description",
job_notes: "Technical notes",
job_parts: "Parts used",
job_labor_hours: "Labour hours",
job_labor_rate: "Labour rate (€/h)",
job_timeline: "Timeline",
job_photos: "Photos",
job_new_quote: "Create Quote",
type_ppm: "PPM",
type_repair: "Repair",
...
iec_title: "Electrical Safety Tests",
iec_subtitle_62353: "IEC 62353",
iec_subtitle_61010: "IEC 61010-1",
iec_reports: "reports",
iec_new: "New test",
iec_report_number: "Report No.",
iec_norm: "Standard",
iec_class: "Equipment class",
iec_patient_type: "Applied part type",
iec_method: "Measurement method",
iec_verify_type: "Test type",
iec_date: "Test date",
iec_technician: "Test engineer",
iec_instrument: "Test instrument",
iec_cal_number: "Instrument calibration No.",
iec_visual: "Visual inspection",
iec_measures: "Electrical measurements",
iec_overall: "Overall result",
iec_pass: "PASS",
iec_fail: "FAIL",
method_direct: "Direct method — Class I 500µA / Class II 100µA",
method_differential: "Differential method — Class I 500µA / Class II 100µA",
method_alternative: "Alternative method — Class I 1000µA / Class II 500µA",
method_direct_desc: "Direct: actual earth leakage via body model. Standard/protected rooms.",
method_differential_desc: "Differential: L/N imbalance measurement. Safe in all environments including IT-isolated wards.",
method_alternative_desc: "Alternative: similar to dielectric test, DUT de-energised. Higher limits apply.",
patient_B: "Type B — Body contact (no applied part leakage test required)",
patient_BF: "Type BF — Isolated floating applied part (≤ 5000µA)",
patient_CF: "Type CF — Direct cardiac application (≤ 50µA)",
patient_B_desc: "Type B: non-isolated body contact — applied part leakage test not required",
patient_BF_desc: "Type BF: isolated floating applied part (e.g. ECG leads, SpO2, defibrillator paddles)",
patient_CF_desc: "Type CF: direct cardiac application — very strict limits",
class_I: "Class I — with protective earth",
class_II: "Class II — double insulated",
class_III: "Class III — SELV",
verify_periodic: "Periodic",
verify_extraordinary: "After repair",
visual_housing: "Housing / Enclosure",
visual_cable: "Mains supply cord",
visual_connectors: "Connectors / accessories",
visual_labels: "Labels / markings",
visual_docs: "Documentation",
visual_ok: "OK",
visual_fail: "Not OK",
visual_na: "N/A",
meas_pe: "Protective earth resistance (PE)",
...
meas_ap_cf_dir: "Applied part leakage current CF (Direct method)",
meas_ap_cf_alt: "Applied part leakage current CF (Alternative method)",
func_title: "Functional Tests",
func_new: "New test",
func_template: "Template",
func_report_number: "Report No.",
func_date: "Test date",
func_technician: "Test engineer",
func_instrument: "Instrument used",
func_verify_type: "Test type",
func_pass: "PASS",
func_fail: "FAIL",
func_item_pass: "✓",
func_item_fail: "✗",
...
func_measure_unit: "Unit",
func_measure_result: "Result",
instruments_title: "Test Instruments",
instrument_new: "New Instrument",
instrument_brand: "Brand",
instrument_model: "Model",
instrument_serial: "Serial No.",
instrument_cal_number: "Calibration No.",
instrument_cal_date: "Calibration date",
instrument_cal_expiry: "Calibration expiry",
instrument_cal_interval: "Interval (months)",
instrument_notes: "Notes",
instrument_renew: "Renew Calibration",
cal_status_ok: "Calibrated",
cal_status_expiring: "Expiring soon",
cal_status_expired: "Expired",
procedures_title: "Technical Procedures",
procedures_subtitle: "Step-by-step guides by specific model (internal knowledge base)",
procedure_new: "New procedure",
procedure_edit: "Edit Procedure",
procedure_model: "Target model",
procedure_brand: "Brand",
procedure_category: "Category",
procedure_type: "Procedure type",
procedure_time: "Estimated time (min)",
procedure_tools: "Required instruments",
procedure_parts: "Typical parts",
procedure_steps: "Procedure steps",
procedure_notes: "Notes & tips",
procedure_step_title: "Step title",
procedure_step_desc: "Detailed description",
procedure_step_expected: "Expected value",
procedure_step_warning: "Warning",
procedure_step_image: "+ Add 1 photo (max 3MB)",
procedure_add_step: "+ Add step",
procedure_created: "Created on",
go_to_procedures: "→ Go to all Procedures",
quotes_title: "Quotations",
quotes_subtitle: "Job quotations → professional PDF",
quote_new: "New quotation",
quote_number: "Quote No.",
quote_date: "Quote date",
quote_valid_until: "Valid until",
quote_customer: "Customer",
quote_job: "Linked job",
quote_status: "Status",
quote_labor: "Labour",
quote_parts: "Parts / Materials",
quote_subtotal: "Net total",
quote_vat: "VAT",
quote_total: "TOTAL",
quote_vat_exempt: "VAT exempt (reverse charge, small business, etc.)",
quote_payment_terms: "Payment terms",
quote_notes: "Notes / special conditions",
quote_add_labor: "+ Add line",
quote_add_free_line: "+ Free line",
quote_from_warehouse: "Add from stock (without decreasing inventory)",
quote_labor_label: "Description (e.g. Travel, Labour hours, Installation…)",
quote_labor_hours: "hours",
quote_labor_rate: "€/h",
quote_subtotal_labor: "Labour subtotal",
quote_subtotal_parts: "Materials subtotal",
quote_create_from_job: "Create quotation",
quote_pdf: "PDF",
status_draft: "Draft",
status_sent: "Sent",
...
kpi_quotes_active: "Active (draft+sent)",
kpi_quotes_accepted: "Accepted",
kpi_quotes_value: "Value sent",
kpi_quotes_total: "Total",
customers_title: "Customers",
customer_new: "New Customer",
customer_edit: "Edit Customer",
customer_name: "Name / Company",
customer_contact: "Contact person",
customer_email: "Email",
customer_phone: "Phone",
customer_address: "Address",
customer_vat: "VAT / Tax No.",
customer_notes: "Notes",
parts_title: "Spare Parts",
part_new: "New Part",
part_name: "Part name",
part_code: "Code / Part Number",
part_brand: "Brand",
part_qty: "Quantity",
part_min_qty: "Minimum stock",
part_unit_price: "Purchase price (€)",
part_sell_price: "Selling price (€)",
part_location: "Storage location",
part_notes: "Notes",
part_low_stock: "Low stock",
part_out_of_stock: "Out of stock",
agenda_title: "Schedule & Calendar",
agenda_month: "Month",
agenda_list: "60-day list",
agenda_auto: "Auto Plan",
agenda_manual: "Manual Plan",
settings_title: "Settings",
settings_company: "Company Details",
settings_company_name: "Company name",
settings_company_subtitle: "Subtitle / specialisation",
settings_company_address: "Address",
settings_company_vat: "VAT number",
settings_company_email: "Email",
settings_company_phone: "Phone",
settings_backup: "Backup & Restore",
settings_export: "⬇ Export backup",
settings_import: "⬆ Import backup",
settings_merge: "⊕ Merge backup",
settings_reset: "⚠ Full reset",
settings_storage: "Storage used",
settings_portal: "Customer Portal Preview",
settings_portal_open: "👁 Open portal preview",
settings_language: "Lingua / Language",
language_it: "Italiano",
language_en: "English",
...
pdf_print: "🖿 Print",
pdf_close: "✕ Close",
pdf_preview: "Document preview",
pdf_iec_title: "ELECTRICAL SAFETY TEST REPORT",
pdf_func_title: "FUNCTIONAL TEST REPORT",
pdf_job_title: "SERVICE REPORT",
pdf_quote_title: "QUOTATION",
pdf_report_number: "REPORT No.",
pdf_date: "Date",
pdf_valid_until: "Valid until",
pdf_technician: "TEST ENGINEER",
pdf_asset: "EQUIPMENT",
pdf_serial: "SERIAL No.",
pdf_brand_model: "BRAND / MODEL",
pdf_location: "LOCATION",
pdf_customer: "CUSTOMER",
pdf_norm: "STANDARD",
pdf_class: "CLASS",
pdf_method: "METHOD",
pdf_patient_type: "APPLIED PART",
pdf_visual_inspection: "Visual Inspection",
pdf_electrical_measures: "Electrical Measurements",
pdf_measure: "Measurement",
pdf_expected: "Limit",
pdf_value: "Value",
pdf_unit: "Unit",
pdf_result: "Result",
...
pdf_fail: "✗ FAIL",
pdf_nd: "N/T",
pdf_overall_pass: "PASS",
pdf_overall_fail: "FAIL",
pdf_footer_not_invoice: "This document is not a tax invoice — use your invoicing software for official billing",
pdf_generated: "Report generated on",
toast_saved: "✓ Saved",
toast_deleted: "Deleted",
toast_pdf_generating: "Generating PDF…",
toast_backup_exported: "Backup exported",
toast_backup_imported: "Data imported successfully",
toast_backup_merged: "Data merged successfully",
toast_reset_done: "Data cleared",
toast_cal_renewed: "Calibration renewed",
toast_quote_created: "✓ Quote created",
toast_quote_updated: "Quote updated",
toast_procedure_saved: "✓ Procedure saved",
toast_procedure_deleted: "Procedure deleted",
toast_duplicated: "✓ Duplicated",
portal_title: "Customer Portal",
portal_banner: "CUSTOMER PORTAL PREVIEW (read-only) — this is what your customer will see",
portal_exit: "✕ Exit preview",
portal_preview_as: "Preview as customer:",
portal_online: "● ONLINE",
portal_request: "Request service",
portal_request_desc: "Report a fault or request a scheduled inspection",
portal_request_btn: "+ New request",
portal_tab_jobs: "Work orders",
portal_tab_assets: "Equipment",
portal_tab_iec: "Elec. Safety",
portal_tab_func: "Functional",
portal_no_jobs: "No work orders recorded",
portal_no_assets: "No equipment recorded",
portal_no_iec: "No electrical safety tests",
portal_no_func: "No functional tests",
portal_no_customers: "No customers",
portal_footer: "Read only — For technical support contact your service engineer",
legal_title: "Legal & Privacy",
help_dashboard_title: "Dashboard",
help_dashboard_steps: [
"Main KPIs: equipment count, open jobs, urgent, open quotes, IEC tests, functional tests, low stock, calibration expiring.",
"All KPI cards are clickable — tap to go directly to that section.",
"Monthly revenue chart built automatically from closed jobs and accepted quotes.",
"Quick access: tap any card to jump to the relevant section.",
],
help_jobs_title: "Jobs / Work Orders",
help_iec_title: "Electrical Safety Tests",
help_func_title: "Functional Tests",
help_instruments_title: "Test Instruments",
help_procedures_title: "Technical Procedures",
help_backup_title: "Backup & Restore",
help_portal_title: "Customer Portal Preview",
help_pwa_title: "Install as App (PWA)",
help_quotes_title: "Quotations",
help_legal_title: "Legal & DMCA",
dmca_title: "Legal & DMCA",
dmca_subtitle: "Information and legal notices",
na_section: "N/A Section",
restore_section: "↩ Restore",
no_events_scheduled: "No events scheduled",
next_services: "Upcoming services",
overdue: "Overdue",
compliant: "PASS",
non_compliant: "FAIL",
operative: "Operative",
...
function createI18n(initialLang) {
let lang = initialLang || 'it';
const listeners = new Set();
const t = (key, vars) => {
const str = (TRANSLATIONS[lang] || TRANSLATIONS['it'])[key]
|| TRANSLATIONS['it'][key]
|| key;
if (!vars)
return str;
...
const getLang = () => lang;
const getAvailable = () => Object.keys(TRANSLATIONS);
const subscribe = (fn) => { listeners.add(fn); return () => listeners.delete(fn); };
return { t, setLang, getLang, getAvailable, subscribe };
}
var i18n = createI18n((() => { try {
return localStorage.getItem('medtrace-lang') || 'it';
}
catch (e) {
return 'it';
} })());
function t(...args) { return i18n ? i18n.t(...args) : args[0]; }
function useLang() {
const [lang, setLangState] = React.useState(i18n.getLang());
React.useEffect(() => {
return i18n.subscribe(newLang => {
localStorage.setItem('medtrace-lang', newLang);
...
${customer.address ? `<div class="kv"><span class="kv-label">{t("customer_address")}</span><span class="kv-value">${customer.address}</span></div>` : ''}
</div>
</div>` : ''}
<div class="section">
...
<div class="kv"><span class="kv-label">{t("serial")}</span><span class="kv-value" style="font-family:monospace">${asset.serial || '—'}</span></div>
...
<div class="kv"><span class="kv-label">{t("technician")}</span><span class="kv-value">${job.assignee || '—'}</span></div>
<div class="kv"><span class="kv-label">{t("job_open_date")}</span><span class="kv-value">${job.openDate}</span></div>
<div class="kv"><span class="kv-label">{t("job_close_date")}</span><span class="kv-value">${job.closeDate || '—'}</span></div>
</div>
...
<table>
<thead><tr><th>{t("date")}</th><th>Tipo</th><th>{t("description")}</th><th style="text-align:right">Ore</th></tr></thead>
<tbody>${tlRows}</tbody>
</table>
</div>` : ''}
...
<table>
<thead><tr><th>{t("description")}</th><th style="text-align:right">Q.tà</th><th style="text-align:right">Prezzo Unit.</th><th style="text-align:right">IVA</th><th style="text-align:right">Importo</th></tr></thead>
...
<div class="kv"><span class="kv-label">{t("serial")}</span><span class="kv-value" style="font-family:monospace">${(asset === null || asset === void 0 ? void 0 : asset.serial) || '—'}</span></div>
...
<div class="kv"><span class="kv-label">{t("iec_verify_type")}</span><span class="kv-value" style="text-transform:capitalize">${rep.verifyType || '—'}</span></div>
<div class="kv"><span class="kv-label">{t("iec_class")}</span><span class="kv-value">Classe ${rep.equipClass || '—'}</span></div>
...
const measHtml = (sec.measures || [])
.filter(m => sd.measures[m.id] !== "na")
.map(m => {
...
const setSectionNA = (section) => {
const naItems = {};
(section.items || []).forEach(item => { naItems[item.id] = "na"; });
const naMeasures = {};
(section.measures || []).forEach(m => { naMeasures[m.id] = "na"; });
setF(x => (Object.assign(Object.assign({}, x), { sections: Object.assign(Object.assign({}, x.sections), { [section.id]: Object.assign(Object.assign({}, getSectionData(section.id)), { sectionNA: true, items: naItems, measures: naMeasures }) }) })));
};
const clearSectionNA = (section) => {
setF(x => (Object.assign(Object.assign({}, x), { sections: Object.assign(Object.assign({}, x.sections), { [section.id]: Object.assign(Object.assign({}, getSectionData(section.id)), { sectionNA: false, items: {}, measures: {} }) }) })));
};
const computePass = () => {
for (const sec of tpl.sections) {
const sd = getSectionData(sec.id);
for (const item of (sec.items || [])) {
if (sd.items[item.id] === "na")
continue;
...
const isNA = val === "na";
const BTNS = [
{ v: true, label: "✓", bg: "#22c55e22", border: "#22c55e44", color: "#22c55e" },
{ v: false, label: "✗", bg: "#ef444422", border: "#ef444433", color: "#ef4444" },
{ v: "na", label: "N/A", bg: "#f59e0b22", border: "#f59e0b44", color: "#f59e0b" },
{ v: null, label: "—", bg: "#2A2A38", border: "#32323F", color: "#64748b" },
];
return (React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 0", borderBottom: "1px solid #1a2030", gap: 10, opacity: isNA ? 0.5 : 1 } },
React.createElement("span", { style: { fontSize: 12, color: isNA ? "#3A3A50" : "#94a3b8", flex: 1, textDecoration: isNA ? "line-through" : "none" } }, item.text),
React.createElement("div", { style: { display: "flex", gap: 4, flexShrink: 0 } }, BTNS.map(({ v, label, bg, border, color }) => (React.createElement("button", { key: String(v), onClick: () => setItem(secId, item.id, v), style: {
background: val === v ? bg : "#141418",
border: `1px solid ${val === v ? border : "#202028"}`,
color: val === v ? color : "#475569",
...
" \u2014 ",
tpl.norm),
React.createElement("span", { style: { fontWeight: 800, fontSize: 14, color: pass ? "#22c55e" : "#ef4444" } }, pass ? t("iec_pass") : t("iec_fail"))),
...
const secData = getSectionData(sec.id);
const isSecNA = secData.sectionNA === true;
return (React.createElement("div", { key: sec.id, style: { background: "#141418", borderRadius: 10, padding: "12px 16px", border: `1px solid ${isSecNA ? "#f59e0b33" : "#1e2a3a"}`, opacity: isSecNA ? 0.6 : 1 } },
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: sec.note ? 4 : 10 } },
React.createElement("div", { style: { fontSize: 11, color: isSecNA ? "#f59e0b" : "#5EEAD4", textTransform: "uppercase", letterSpacing: .8, fontWeight: 700, textDecoration: isSecNA ? "line-through" : "none" } }, sec.title),
React.createElement("button", { onClick: () => isSecNA ? clearSectionNA(sec) : setSectionNA(sec), style: {
background: isSecNA ? "#f59e0b22" : "#141418",
border: `1px solid ${isSecNA ? "#f59e0b44" : "#2A2A38"}`,
color: isSecNA ? "#f59e0b" : "#64748b",
borderRadius: 5, padding: "2px 8px", cursor: "pointer", fontSize: 10, fontWeight: 700, flexShrink: 0,
} }, isSecNA ? "↩ Ripristina" : "N/A Sezione")),
!isSecNA && sec.note && (React.createElement("div", { style: { fontSize: 10, color: "#475569", marginBottom: 10, fontStyle: "italic", background: "#0D0D12", padding: "5px 8px", borderRadius: 5, borderLeft: "2px solid #475569" } },
"\u2139 ",
sec.note)),
!isSecNA && (sec.items || []).map(item => renderItemRow({ secId: sec.id, item })),
!isSecNA && (sec.measures || []).length > 0 && (React.createElement("div", { style: { marginTop: (sec.items || []).length > 0 ? 10 : 0 } },
...
React.createElement(Btn, { variant: "ghost", onClick: onClose }, t("cancel")),
React.createElement(Btn, { onClick: () => onSave(Object.assign(Object.assign({}, f), { assetId: f.assetId || selectedAssetId, overallPass: pass, templateId })) }, i18n.getLang() === "en" ? "Save report" : "Salva rapporto"))));
}
...
React.createElement("span", { style: { fontWeight: 800, fontSize: 14, color: f.overallPass ? "#22c55e" : "#ef4444" } }, f.overallPass ? t("iec_pass") : t("iec_fail"))),
!propAssetId && (React.createElement("div", { style: FLD },
React.createElement("label", { style: LBL }, "Apparecchio"),
...
React.createElement("div", { style: FLD },
React.createElement("label", { style: LBL }, t("date")),
React.createElement("input", { type: "date", value: f.date, onChange: sv("date"), style: INP })),
React.createElement("div", { style: FLD },
React.createElement("label", { style: LBL }, t("iec_norm")),
...
React.createElement("div", { style: FLD },
React.createElement("label", { style: LBL }, t("iec_class")),
...
React.createElement("div", { style: { display: "flex", gap: 10, justifyContent: "flex-end" } },
React.createElement(Btn, { variant: "ghost", onClick: onClose }, t("cancel")),
React.createElement(Btn, { onClick: () => onSave(Object.assign(Object.assign({}, f), { assetId: f.assetId || propAssetId || "" })) }, i18n.getLang() === "en" ? "Save report" : "Salva rapporto"))));
}
...
return [
{
icon: "›", title: isEN ? "Dashboard" : "Dashboard", color: "#2DD4BF",
steps: isEN ? [
"Main KPIs: equipment count, open jobs, urgent, open quotes, IEC tests, functional tests, low stock, calibration expiring.",
"All KPI cards are clickable — tap to navigate directly to that section.",
"Monthly revenue chart built automatically from closed jobs and accepted quotes.",
] : [
"KPI principali: apparecchi, job aperti, urgenti, preventivi aperti, verifiche IEC, verifiche funz., stock basso, strumenti in scadenza.",
"Tutti i KPI sono cliccabili — tocca per navigare direttamente alla sezione.",
"Grafico ricavi mensili costruito automaticamente da job chiusi e preventivi accettati.",
]
},
{
icon: "›", title: isEN ? "Jobs / Work Orders" : "Job / Interventi", color: "#2DD4BF",
steps: isEN ? [
"Create a job for each intervention: PPM, repair, verification, installation.",
"Priority levels: Urgent, High, Normal, Low.",
"Timeline: add steps as you work — date, note, optional photo.",
"Parts used: select from warehouse, quantities are automatically deducted.",
"Labour hours × rate = calculated cost automatically.",
"Green € button on each row: create a quote pre-filled with job parts and hours.",
"PDF report generated directly on device.",
] : [
"Crea un job per ogni intervento: PPM, riparazione, verifica, installazione.",
"Priorità: Urgente, Alta, Normale, Bassa.",
"Timeline: aggiungi step mentre lavori — data, nota, foto opzionale.",
"Parti utilizzate: seleziona dal magazzino, le quantità vengono scalate automaticamente.",
"Ore manodopera × tariffa = costo calcolato automaticamente.",
"Pulsante verde € su ogni riga: crea preventivo pre-compilato con parti e ore del job.",
"PDF rapporto generato direttamente sul dispositivo.",
]
},
{
icon: "›", title: isEN ? "Electrical Safety Tests" : "Verifiche di Sicurezza Elettrica", color: "#2DD4BF",
steps: isEN ? [
"Select standard (IEC 62353 for medical devices, IEC 61010-1 for laboratory equipment), class (I/II/III) and applied part type (B/BF/CF).",
"Limits follow IEC 62353:2014 Table 2 and update automatically based on Class, applied part type and selected method.",
"MEASUREMENT METHOD: Direct (actual earth leakage — standard rooms), Differential (L/N imbalance — safe in IT-isolated wards), Alternative (similar to dielectric test, DUT de-energised).",
"EQUIPMENT LEAKAGE Class I: ≤ 500 µA (Direct/Differential), ≤ 1000 µA (Alternative). Class II: ≤ 100 µA (Direct/Differential), ≤ 500 µA (Alternative).",
"APPLIED PART LEAKAGE (F-type only): BF ≤ 5000 µA, CF ≤ 50 µA. Type B: no test required.",
"Each measurement shows PASS ✓ or FAIL ✗ in real time as you enter the value.",
"Saving creates a linked Job and updates Next Service date to +1 year.",
] : [
"Scegli norma (IEC 62353 per elettromedicali, IEC 61010 per laboratorio), classe (I/II/III) e tipo paziente (B/BF/CF).",
"I limiti seguono la Tabella 2 della IEC 62353:2014 e cambiano automaticamente in base a Classe, tipo paziente e metodo.",
"METODO DI MISURA: Direct (diretto, stanze standard), Differential (differenziale, anche stanze IT isolate), Alternative (DUT spento, limiti più alti).",
...
"APPLIED PART LEAKAGE (solo F-type): BF ≤ 5000 µA, CF ≤ 50 µA. Type B: nessun test.",
"Ogni misura mostra PASS ✓ o FAIL ✗ in tempo reale.",
"Salvando si crea un Job collegato e si aggiorna il Prossimo Servizio a +1 anno.",
]
},
{
icon: "›", title: isEN ? "Functional Tests" : "Verifiche Funzionali", color: "#0D9488",
steps: isEN ? [
"Templates available (standard in brackets): Defibrillator (IEC 60601-2-4), AED (IEC 60601-2-4), Surgical suction (ISO 10079-1), Electrosurgical unit (IEC 60601-2-2), Patient monitor (IEC 60601-2-27/30/49), Ventilator (ISO 80601-2-12), Infusion pump (IEC 60601-2-24), Ultrasound (IEC 60601-2-37), Electric bed (IEC 60601-2-38), Generic.",
"Template is auto-detected from the equipment name.",
"INTERCHANGEABLE UNITS: for pressure measurements (vacuum, PEEP, Ppeak, NIBP, etc.) tap the unit shown next to the value — kPa, mmHg, cmH2O, mbar, hPa are interconvertible, pass/fail recalculated automatically.",
"N/A SECTIONS: tap 'N/A Section' to mark an entire section as not applicable (e.g. battery test for mains-only devices). N/A sections and items are excluded from PASS/FAIL and are not shown in the PDF.",
"Internal guidance notes (OPTIONAL — perform only if…) are visible in the app but NOT shown in the client PDF.",
"Overall PASS/FAIL updates automatically as you fill in the form.",
] : [
"Template disponibili: Defibrillatore (IEC 60601-2-4), DAE, Aspiratore (ISO 10079-1), Elettrobisturi (IEC 60601-2-2), Monitor (IEC 60601-2-27/30/49), Ventilatore (ISO 80601-2-12), Pompa infusionale (IEC 60601-2-24), Ecografo (IEC 60601-2-37), Letto elettrico (IEC 60601-2-38), Generico.",
"Il template viene auto-rilevato dal nome dell'apparecchio selezionato.",
"UNITÀ INTERCAMBIABILI: per le misure di pressione tocca l'unità a fianco del valore — kPa, mmHg, cmH2O, mbar, hPa sono interconvertibili, pass/fail ricalcolato in automatico.",
"SEZIONI N/A: tocca 'N/A Sezione' per marcare un'intera sezione come non applicabile. Sezioni e item N/A sono esclusi dal risultato e non appaiono nel PDF.",
"Le note interne (OPZIONALE — eseguire solo se…) sono visibili nell'app ma NON nel PDF del cliente.",
"L'esito CONFORME/NON CONFORME si aggiorna automaticamente mentre compili.",
]
},
{
icon: "›", title: isEN ? "Test Instruments" : "Strumenti di Misura", color: "#f59e0b",
steps: isEN ? [
"Register your test instruments: brand, model, serial number, calibration certificate number.",
"Set calibration interval (6/12/24/36 months) — the system automatically calculates the expiry date.",
"Traffic light indicator: green (valid), amber (expiring within 60 days), red (expired).",
"Instruments expiring soon appear as a badge on the nav item and on the Dashboard KPI.",
"When you create an IEC or functional test, registered instruments appear in the dropdown — one tap fills in the instrument field.",
"Use 'Renew Calibration' to log a new calibration and reset the expiry countdown.",
] : [
"Registra i tuoi strumenti di misura: marca, modello, seriale, n° certificato di taratura.",
"Imposta l'intervallo di calibrazione (6/12/24/36 mesi) — il sistema calcola automaticamente la scadenza.",
"Semaforo: verde (valido), arancione (scadenza entro 60 giorni), rosso (scaduto).",
"Strumenti in scadenza appaiono come badge nel menu e nel KPI dashboard.",
"Nelle verifiche IEC e funzionali, gli strumenti registrati appaiono nel dropdown — un tocco compila il campo tester.",
"Usa 'Rinnova Calibrazione' per registrare una nuova taratura e azzerare il conto alla rovescia.",
]
},
{
icon: "›", title: isEN ? "Technical Procedures" : "Procedure Tecniche", color: "#2DD4BF",
steps: isEN ? [
"Internal knowledge base — iFixit-style step-by-step guides for specific equipment models.",
"For each procedure: target brand/model, category, type (PPM/calibration/troubleshooting), estimated time, required instruments, typical parts.",
"Numbered steps: each step has a title, detailed description, expected value, optional warning, and 1 optional photo (max 3MB).",
"Reorder steps with ↑↓ arrows. Duplicate an entire procedure to create a similar one.",
"Quick search by model/brand/category. Equipment record → Procedures tab shows only procedures relevant to that model.",
"⚠ localStorage limit: ~10MB total. Keep photos small; attach full service manual PDFs to the equipment or job record.",
] : [
"Knowledge base interna — guide passo-passo per modello specifico.",
"Per ogni procedura: marca/modello, categoria, tipo (PPM/calibrazione/troubleshooting), tempo stimato, strumenti, ricambi.",
"Passi numerati con titolo, descrizione, valore atteso, avvertenza opzionale, 1 foto opzionale (max 3MB).",
"Riordina passi con ↑↓, duplica procedura intera.",
"Cerca per modello/marca/categoria. Scheda apparecchio → tab Procedure mostra solo quelle rilevanti per quel modello.",
"⚠ Limite localStorage: ~10MB totali. Mantieni le foto leggere; allega i PDF dei manuali di servizio agli apparecchi.",
]
},
{
icon: "›", title: isEN ? "Quotes" : "Preventivi", color: "#22c55e",
steps: isEN ? [
"Create quotes directly from the Jobs table (green € button) — parts and labour hours are pre-filled from the job without deducting stock.",
"Multiple labour lines: each with a free label (Travel, Labour hours, Installation…), hours and hourly rate.",
"Mixed material lines: from warehouse stock (price editable) OR free lines for parts not in stock.",
"VAT exempt toggle for small businesses / reverse charge.",
"Status: Draft → Sent → Accepted → Rejected → Expired. Default validity: 90 days.",
"Professional PDF quote with itemised labour and materials. Not a tax invoice.",
"For electronic invoicing use your dedicated invoicing software (e.g. Xero, QuickBooks, etc.).",
] : [
"Crea preventivi dalla tabella Job (pulsante verde €) — parti e ore importate dal job senza scalare lo stock.",
"Voci manodopera multiple con etichetta libera (Trasferta, Ore lavoro, Installazione…), ore e tariffa/h.",
"Righe materiali miste: dal magazzino + righe libere per ricambi non a magazzino.",
"Toggle Esente IVA per forfettari / art.10.",
"Stati: Bozza → Inviato → Accettato → Rifiutato → Scaduto. Validità default: 90 giorni.",
"PDF preventivo professionale con dettaglio manodopera e materiali. Non è una fattura.",
"Per le fatture elettroniche usa il tuo software dedicato.",
]
},
{
icon: "›", title: isEN ? "Customer Portal Preview" : "Portale Cliente", color: "#2DD4BF",
steps: isEN ? [
"Go to Settings → 'Open portal preview' to see the app as your customer would see it.",
"The portal is READ ONLY — customer sees their equipment, open work orders with timeline, IEC/functional test reports, downloadable attachments.",
"In preview mode you can switch between customers from the dropdown to see each one's perspective.",
"THIS IS A SKELETON: currently works offline with your local data. When Supabase is enabled, each customer will have a unique link (e.g. medtrace.app/portal/abc123) for real-time remote access.",
] : [
...
"In modalità anteprima puoi switchare tra clienti diversi per vedere la prospettiva di ognuno.",
"SKELETON OFFLINE: quando attiveremo Supabase, ogni cliente avrà un link unico per accedere da remoto in tempo reale.",
]
},
{
icon: "›", title: isEN ? "Backup & Restore" : "Backup e Ripristino", color: "#64748b",
steps: isEN ? [
"EXPORT: downloads a complete JSON backup of ALL data (equipment, jobs, parts, customers, quotes, IEC tests, functional tests, instruments, procedures, attachments).",
"IMPORT: replaces all current data with the backup file — confirmation dialog before proceeding.",
"MERGE: adds records from the backup file without deleting existing data — useful for combining data from two devices.",
"The backup file includes metadata: export date, app version, record counts.",
"Recommended: export a backup before any major operation (reset, large import).",
"⚠ FULL RESET deletes all data permanently — cannot be undone.",
] : [
"ESPORTA: scarica un backup JSON completo di TUTTI i dati (apparecchi, job, parti, clienti, preventivi, verifiche, strumenti, procedure, allegati).",
"IMPORTA: sostituisce tutti i dati correnti con il file di backup — dialog di conferma prima di procedere.",
"UNISCI: aggiunge i record del backup senza cancellare i dati esistenti — utile per unire dati da due dispositivi.",
"Il file di backup include metadati: data esportazione, versione app, conteggio record.",
"Consigliato: esporta un backup prima di operazioni importanti.",
"⚠ RESET COMPLETO elimina tutti i dati in modo permanente — non annullabile.",
]
},
{
icon: "›", title: isEN ? "Install as App (PWA)" : "PWA — Installa come app", color: "#0D9488",
steps: isEN ? [
"MedTrace can be installed as a native app on iOS (Safari → Share → Add to Home Screen) and Android (Chrome → ⋮ → Add to Home Screen).",
"Once installed it works completely offline — no internet connection required.",
"App icon appears on the home screen like any other app.",
"iOS: tap Share (□↑) → scroll down → 'Add to Home Screen'.",
"Android Chrome: tap ⋮ menu → 'Add to Home Screen' or 'Install app'.",
] : [
"MedTrace può essere installato come app nativa su iOS (Safari → Condividi → Aggiungi a schermata Home) e Android (Chrome → ⋮ → Aggiungi a schermata Home).",
"Una volta installato funziona completamente offline.",
"L'icona appare sulla schermata home come qualsiasi altra app.",
"iOS: tocca Condividi (□↑) → scorri → 'Aggiungi a schermata Home'.",
"Android Chrome: tocca ⋮ → 'Aggiungi a schermata Home' o 'Installa app'.",
]
},
];
}
...
getHelpSections().map((section, si) => {
...
const isEN = i18n.getLang() === "en";
const sections = [
{ id: 'privacy', label: isEN ? 'Privacy Policy' : 'Informativa Privacy' },
{ id: 'gdpr', label: 'GDPR' },
{ id: 'terms', label: isEN ? 'Terms of Service' : 'Termini di Servizio' },
{ id: 'dmca', label: 'DMCA / Copyright' },
{ id: 'about', label: isEN ? 'About' : 'Note sul Software' },
];
const today = new Date().toLocaleDateString(isEN ? 'en-GB' : 'it-IT');
const CONTENT = {
privacy: isEN ? {
...
**Last updated:** ${today}
**1. Data Controller**
MedTrace is operated as a personal tool. The operator of this application is the individual or organisation that has deployed it. No data is transmitted to third parties.
**2. Data collected**
MedTrace collects only the data you enter manually: equipment records, work orders, customers, test reports, spare parts, procedures and quotations.
**3. Storage**
All data is stored exclusively in your browser's localStorage on the device you use. No data is sent to any server, cloud service or third party without your explicit action (e.g. backup export).
**4. Data retention**
Data persists until you clear your browser storage or perform a full reset within the app. You can export a backup at any time from Settings.
**5. Your rights**
You have full control over your data: you can view, modify, export and delete it at any time through the application interface.
**6. Cookies**
MedTrace does not use cookies or tracking technologies.
**7. Contact**
For any privacy-related enquiries, contact the operator of this installation directly.
`
} : {
...
MedTrace è uno strumento personale/professionale. Il titolare del trattamento è il soggetto che ha installato e utilizza questa applicazione. Nessun dato viene trasmesso a terzi.
**2. Dati raccolti**
MedTrace raccoglie esclusivamente i dati inseriti manualmente dall'utente: anagrafica apparecchi, job, clienti, rapporti di verifica, magazzino, procedure e preventivi.
**3. Conservazione**
Tutti i dati sono conservati esclusivamente nel localStorage del browser sul dispositivo in uso. Nessun dato viene inviato a server, cloud o terze parti senza un'azione esplicita dell'utente (es. esportazione backup).
**4. Conservazione dei dati**
I dati persistono fino alla cancellazione del browser storage o al reset completo dall'applicazione. È possibile esportare un backup in qualsiasi momento dalle Impostazioni.
**5. Diritti dell'utente**
L'utente ha pieno controllo sui propri dati: può visualizzarli, modificarli, esportarli ed eliminarli in qualsiasi momento tramite l'interfaccia dell'applicazione.
**6. Cookie**
MedTrace non utilizza cookie né tecnologie di tracciamento.
**7. Contatti**
Per qualsiasi richiesta relativa alla privacy, contattare direttamente il titolare dell'installazione.
`
},
gdpr: {
title: "GDPR — " + (isEN ? "General Data Protection Regulation" : "Regolamento Generale sulla Protezione dei Dati"),
body: isEN ? `
**Compliance statement**
MedTrace processes personal data in accordance with Regulation (EU) 2016/679 (GDPR).
**Legal basis for processing**
Data is processed on the basis of legitimate interest (Art. 6(1)(f) GDPR) for the management of biomedical equipment maintenance activities, and/or on the basis of contractual obligation (Art. 6(1)(b)) where a service contract exists with the customer.
**Categories of personal data processed**
- Customer identification data (name, company, address, VAT number, contact details)
- Technical data relating to equipment and interventions
- Work order and test report data
**Data subjects' rights (Art. 15–22 GDPR)**
Data subjects have the right to: access, rectification, erasure, restriction of processing, data portability and objection. Since all data is stored locally on your device, these rights are exercised directly through the application.
**Data retention**
Data is retained for as long as necessary for the maintenance management activity and applicable legal obligations (typically 10 years for technical documentation in the medical device sector).
**Data transfers**
No data is transferred outside the EU/EEA. No automated decision-making or profiling takes place.
**Data Protection Officer**
Not applicable for this type of processing. Contact the operator for any GDPR-related requests.
` : `
**Dichiarazione di conformità**
MedTrace tratta dati personali nel rispetto del Regolamento (UE) 2016/679 (GDPR).
**Base giuridica del trattamento**
I dati sono trattati sulla base del legittimo interesse (art. 6(1)(f) GDPR) per la gestione delle attività di manutenzione di apparecchiature elettromedicali, e/o sulla base dell'obbligo contrattuale (art. 6(1)(b)) ove esista un contratto di servizio con il cliente.
**Categorie di dati personali trattati**
- Dati identificativi dei clienti (nome, ragione sociale, indirizzo, P.IVA, contatti)
- Dati tecnici relativi agli apparecchi e agli interventi
- Dati di job e rapporti di verifica
**Diritti degli interessati (artt. 15–22 GDPR)**
Gli interessati hanno diritto di: accesso, rettifica, cancellazione, limitazione del trattamento, portabilità e opposizione. Poiché tutti i dati sono archiviati localmente sul dispositivo, tali diritti si esercitano direttamente attraverso l'applicazione.
**Conservazione dei dati**
I dati sono conservati per il tempo necessario all'attività di gestione della manutenzione e agli obblighi di legge applicabili (tipicamente 10 anni per la documentazione tecnica nel settore dei dispositivi medici).
**Trasferimenti di dati**
Nessun dato viene trasferito al di fuori dell'UE/SEE. Non vengono effettuate decisioni automatizzate né profilazione.
**Responsabile della Protezione dei Dati (DPO)**
Non applicabile per questa tipologia di trattamento. Contattare il titolare per qualsiasi richiesta GDPR.
`
},
terms: isEN ? {
...
**Last updated:** ${today}
**1. Acceptance**
By using MedTrace you accept these terms in full. If you do not agree, do not use the application.
**2. Licence**
MedTrace is provided as a personal or professional productivity tool. Unauthorised redistribution, resale or sublicensing is prohibited.
**3. Intended use**
MedTrace is designed to assist biomedical equipment technicians in managing maintenance records, electrical safety tests, functional tests and quotations. It does not replace the professional judgement of a qualified technician, nor does it certify compliance with any standard.
**4. Data responsibility**
The user is solely responsible for the accuracy and completeness of the data entered. MedTrace stores data locally and does not validate the technical content of test records.
**5. Reports and documents**
PDF reports generated by MedTrace are produced for internal record-keeping purposes. The accuracy of test results depends entirely on the values entered by the user. No warranty is given as to the fitness of any document for regulatory submission.
**6. Limitation of liability**
MedTrace is provided "as is" without warranty of any kind. The developer shall not be liable for any loss or damage arising from the use or inability to use the application.
**7. Changes**
...
**Ultimo aggiornamento:** ${today}
**1. Accettazione**
Utilizzando MedTrace accetti integralmente i presenti termini. In caso di disaccordo, non utilizzare l'applicazione.
**2. Licenza**
MedTrace è fornito come strumento di produttività personale o professionale. È vietata la ridistribuzione, la rivendita o la sub-licenza non autorizzata.
**3. Uso previsto**
MedTrace è progettato per assistere i tecnici di ingegneria clinica nella gestione della documentazione di manutenzione, verifiche di sicurezza elettrica, verifiche funzionali e preventivi. Non sostituisce il giudizio professionale di un tecnico qualificato, né certifica la conformità a norme tecniche.
**4. Responsabilità sui dati**
L'utente è il solo responsabile dell'accuratezza e completezza dei dati inseriti. MedTrace archivia i dati localmente e non valida il contenuto tecnico dei rapporti.
**5. Rapporti e documenti**
I rapporti PDF generati da MedTrace sono prodotti a fini di registrazione interna. L'accuratezza dei risultati delle verifiche dipende interamente dai valori inseriti dall'utente. Non viene fornita alcuna garanzia sull'idoneità dei documenti per la presentazione a enti di vigilanza.
**6. Limitazione di responsabilità**
MedTrace è fornito "così com'è" senza garanzie di alcun tipo. Lo sviluppatore non è responsabile per perdite o danni derivanti dall'uso o dall'impossibilità di utilizzare l'applicazione.
**7. Modifiche**
I presenti termini possono essere aggiornati in qualsiasi momento. L'utilizzo continuato dell'applicazione costituisce accettazione dei termini aggiornati.
`
},
dmca: {
...
body: isEN ? `
**Copyright Notice**
© 2025–2026 MedTrace. All rights reserved.
**Intellectual Property**
MedTrace, including its source code, design, templates, and normative content, is the intellectual property of the developer. Unauthorised reproduction, distribution or modification is prohibited.
**Third-party standards**
References to IEC 62353, IEC 60601, ISO 80601, ISO 10079 and other standards are made for informational purposes only. The full text of these standards is owned by their respective publishers (IEC, ISO, CEN) and is not reproduced in this application.
**DMCA — Digital Millennium Copyright Act**
If you believe that content in this application infringes your copyright, please contact the operator with the following information:
...
**Disclaimer**
MedTrace is an independent product and is not affiliated with, endorsed by, or sponsored by IEC, ISO, Fluke, Rigel, Philips, or any other manufacturer or standards body mentioned in the application.
` : `
**Avviso di Copyright**
© 2025–2026 MedTrace. Tutti i diritti riservati.
**Proprietà intellettuale**
MedTrace, inclusi codice sorgente, design, template e contenuti normativi, è di proprietà intellettuale dello sviluppatore. La riproduzione, distribuzione o modifica non autorizzata è vietata.
**Standard di terze parti**
I riferimenti a IEC 62353, IEC 60601, ISO 80601, ISO 10079 e altre norme sono effettuati a soli fini informativi. Il testo completo di tali norme è di proprietà dei rispettivi editori (IEC, ISO, CEN) e non è riprodotto in questa applicazione.
**DMCA — Digital Millennium Copyright Act**
Se ritieni che dei contenuti di questa applicazione violino il tuo copyright, contatta il titolare fornendo:
- Identificazione dell'opera protetta da copyright
- Identificazione del materiale presumibilmente lesivo
- Le tue informazioni di contatto
- Dichiarazione in buona fede che l'uso non è autorizzato
- Dichiarazione, a pena di falsa testimonianza, che le informazioni sono accurate
**Disclaimer**
MedTrace è un prodotto indipendente e non è affiliato, approvato o sponsorizzato da IEC, ISO, Fluke, Rigel, Philips o da qualsiasi altro produttore o ente di normazione citato nell'applicazione.
`
},
about: {
title: isEN ? "About MedTrace" : "Note sul Software",
body: isEN ? `
**MedTrace v2.2**
Biomedical Equipment CMMS
**Purpose**
MedTrace is a Computerised Maintenance Management System (CMMS) designed specifically for biomedical equipment technicians. It provides tools for managing equipment registers, work orders, electrical safety tests (IEC 62353 / IEC 61010-1), functional tests, calibration tracking, technical procedures and professional quotations.
**Key features**
- Equipment register with full service history
- IEC 62353:2014 electrical safety testing with correct normative limits (Direct / Differential / Alternative methods)
- Functional test templates for 10 device categories with N/A section support
- Step-by-step technical procedures knowledge base (iFixit-style)
- Job management with timeline, parts and labour tracking
- Professional PDF reports and quotations
- Customer portal preview
- Offline-first PWA — works without internet connection
- IT / EN bilingual interface
**Standards referenced**
IEC 62353:2014 · IEC 60601-1 · IEC 60601-2-4 · IEC 60601-2-27 · ISO 80601-2-12 · ISO 10079-1 · IEC 60601-2-2 · IEC 60601-2-24 · IEC 60601-2-37
**Technology**
React 18 · localStorage · PWA · jsPDF · html2canvas · SheetJS
**Roadmap**
Supabase cloud sync · Multi-user authentication · Community procedures database · Stripe billing · Native Android/iOS app (Capacitor)
` : `
**MedTrace v2.2**
CMMS per Apparecchiature Elettromedicali
**Scopo**
MedTrace è un sistema CMMS (Computerized Maintenance Management System) progettato specificamente per i tecnici di ingegneria clinica. Fornisce strumenti per la gestione dell'anagrafica apparecchi, job, verifiche di sicurezza elettrica (IEC 62353 / IEC 61010-1), verifiche funzionali, calibrazione strumenti, procedure tecniche e preventivi professionali.
**Funzionalità principali**
- Anagrafica apparecchi con storico completo degli interventi
- Verifiche sicurezza elettrica IEC 62353:2014 con limiti normativi corretti (metodi Direct / Differential / Alternative)
- Template verifiche funzionali per 10 categorie di dispositivi con supporto sezioni N/A
- Knowledge base procedure tecniche passo-passo (stile iFixit)
- Gestione job con timeline, parti e ore manodopera
- PDF rapporti e preventivi professionali
- Portale cliente (anteprima)
- PWA offline-first — funziona senza connessione internet
...
React 18 · localStorage · PWA · jsPDF · html2canvas · SheetJS
**Roadmap**
Supabase cloud sync · Autenticazione multi-utente · Database procedure community · Stripe billing · App Android/iOS nativa (Capacitor)
`
},
};
const current = CONTENT[section] || CONTENT.about;
const renderMarkdown = (text) => {
return text.trim().split('\n').map((line, i) => {
if (line.startsWith('**') && line.endsWith('**') && line.length > 4) {
return React.createElement("div", { key: i, style: { fontWeight: 800, color: '#F0F0F5', marginTop: i > 0 ? 14 : 0, marginBottom: 4, fontSize: 13 } }, line.slice(2, -2));
}
if (line.startsWith('- ')) {
return React.createElement("div", { key: i, style: { color: '#9090A8', fontSize: 12, paddingLeft: 12, marginBottom: 3 } },
"\u00B7 ",
line.slice(2));
}
if (!line.trim())
return React.createElement("div", { key: i, style: { height: 6 } });
return React.createElement("div", { key: i, style: { color: '#9090A8', fontSize: 12, lineHeight: 1.7, marginBottom: 2 } }, line);
});
};
return (React.createElement("div", { style: { maxWidth: 860, margin: '0 auto', padding: '0 4px' } },
React.createElement("div", { style: { marginBottom: 20 } },
React.createElement("h1", { style: { margin: '0 0 4px', fontSize: 22, fontWeight: 900, color: '#F0F0F5' } }, isEN ? 'Legal & Compliance' : 'Legale & Compliance'),
React.createElement("p", { style: { color: '#5A5A70', margin: 0, fontSize: 13 } }, isEN ? 'Privacy, GDPR, Terms of Service, DMCA and software information'
: 'Privacy, GDPR, Termini di Servizio, DMCA e informazioni sul software')),
React.createElement("div", { style: { display: 'flex', gap: 4, marginBottom: 16, overflowX: 'auto', borderBottom: '2px solid #2A2A38', paddingBottom: 0 } }, sections.map(s => (React.createElement("button", { key: s.id, onClick: () => setSection(s.id), style: {
background: 'none', border: 'none',
borderBottom: section === s.id ? '2px solid #2DD4BF' : '2px solid transparent',
color: section === s.id ? '#2DD4BF' : '#64748b',
padding: '8px 14px', cursor: 'pointer', fontSize: 12, fontWeight: 700,
marginBottom: -2, whiteSpace: 'nowrap', flexShrink: 0,
} }, s.label)))),
React.createElement("div", { style: { background: '#141418', border: '1px solid #2A2A38', borderRadius: 12, padding: '20px 24px' } },
React.createElement("h2", { style: { margin: '0 0 16px', fontSize: 16, fontWeight: 800, color: '#F0F0F5' } }, current.title),
React.createElement("div", null, renderMarkdown(current.body)))));
}
...
React.createElement("h1", { style: { margin: 0, fontSize: 20, fontWeight: 900 } }, t("instruments_title")),
...
(modal === null || modal === void 0 ? void 0 : modal.type) === 'renew' && (React.createElement(Modal, { title: t("instrument_renew"), onClose: () => setModal(null) },
...
React.createElement("div", { style: ROW },
React.createElement("div", { style: COL },
React.createElement("label", { style: LBL }, t("serial")),
...
React.createElement("label", { style: LBL }, t("instrument_cal_interval")),
...
React.createElement("div", { style: ROW },
React.createElement("div", { style: COL },
React.createElement("label", { style: LBL }, t("instrument_cal_expiry")),
...
React.createElement("label", { style: LBL }, t("notes")),
...
color: '#94a3b8', padding: '9px 18px', cursor: 'pointer', fontWeight: 700, fontSize: 13 } }, t("cancel")),
...
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, flexWrap: 'wrap', gap: 10 } },
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 20, fontWeight: 900 } }, t("agenda_title")),
...
{ id: 'jobs', label: `${i18n.getLang() === "en" ? "Work orders" : "Interventi"} (${customerJobs.length})` },
{ id: 'assets', label: `${i18n.getLang() === "en" ? "Equipment" : "Apparecchi"} (${customerAssets.length})` },
{ id: 'iec', label: `${i18n.getLang() === "en" ? "Elec. Safety" : "Sic. Elettrica"} (${customerIec.length})` },
{ id: 'func', label: `${i18n.getLang() === "en" ? "Functional" : "Funzionali"} (${customerFunc.length})` },
...
const delProc = (id) => {
if (!confirm(i18n.getLang() === 'en' ? 'Delete this procedure?' : 'Eliminare questa procedura?'))
return;
...
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, flexWrap: 'wrap', gap: 10 } },
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 20, fontWeight: 900 } }, t("procedures_title")),
React.createElement("p", { style: { color: '#64748b', margin: '3px 0 0', fontSize: 12 } }, i18n.getLang() === "en" ? "Step-by-step guides for specific models (internal knowledge base)" : "Guide passo-passo per modello specifico (knowledge base interna)")),
...
React.createElement("input", { value: search, onChange: e => setSearch(e.target.value), placeholder: i18n.getLang() === "en" ? "Search by model, brand, category…" : "Cerca per modello, marca, categoria…", style: { flex: 1, minWidth: 200, background: '#141418', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#F0F0F5', fontSize: 13, outline: 'none' } }),
...
React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: '#94a3b8', marginBottom: 6 } }, i18n.getLang() === "en" ? "No procedures yet" : "Nessuna procedura ancora"),
...
React.createElement("div", { style: ROW },
React.createElement("div", { style: { flex: 1, minWidth: 140 } },
React.createElement("label", { style: LBL }, t("brand")),
...
React.createElement("button", { onClick: onClose, style: { background: '#202028', border: '1px solid #2a3040', borderRadius: 7, color: '#94a3b8', padding: '9px 18px', cursor: 'pointer', fontWeight: 700, fontSize: 13 } }, t("cancel")),
...
(onEdit || onDelete || actions) && React.createElement("th", { style: Object.assign(Object.assign({}, TH_S), { cursor: "default" }) }, t("actions"))),
React.createElement("tr", null,
...
React.createElement("td", { colSpan: cols.length + (onEdit || onDelete || actions ? 1 : 0), style: { textAlign: "center", padding: 32, color: "#475569" } }, i18n.getLang() === "en" ? "No results" : "Nessun risultato"))) : filtered.map((row, i) => {
...
onDelete && React.createElement("button", { onClick: () => { if (confirm(i18n.getLang() === "en" ? "Delete this row? This action cannot be undone." : "Eliminare questa riga? L'azione non si può annullare."))
...
jobId: '',
date: new Date().toISOString().slice(0, 10),
validUntil: (() => { const d = new Date(); d.setDate(d.getDate() + 90); return d.toISOString().slice(0, 10); })(),
status: 'bozza',
laborLines: [],
partLines: [],
notes: '',
...
React.createElement("div", null,
React.createElement("label", { style: LBL }, t("status")),
...
const delQuote = (id) => {
if (!confirm(i18n.getLang() === 'en' ? 'Delete this quote?' : 'Eliminare questo preventivo?'))
return;
...
React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, flexWrap: 'wrap', gap: 10 } },
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 20, fontWeight: 900 } }, t("quotes_title")),
React.createElement("p", { style: { color: '#64748b', margin: '3px 0 0', fontSize: 12 } }, i18n.getLang() === "en" ? "Job quotations → professional PDF" : "Quotazioni da job → PDF professionale")),
...
React.createElement("div", { style: { display: 'flex', gap: 8, marginBottom: 14, flexWrap: 'wrap' } },
React.createElement("input", { value: search, onChange: e => setSearch(e.target.value), placeholder: i18n.getLang() === "en" ? "Search by number, customer…" : "Cerca numero, cliente…", style: { flex: 1, minWidth: 180, background: '#141418', border: '1px solid #2A2A38', borderRadius: 8, padding: '8px 12px', color: '#F0F0F5', fontSize: 13, outline: 'none' } }),
...
React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: '#94a3b8', marginBottom: 6 } }, i18n.getLang() === "en" ? "No quotes yet" : "Nessun preventivo ancora"),
React.createElement("div", { style: { fontSize: 12, marginBottom: 14 } }, "Apri un job, usa il pulsante \"Crea preventivo\" oppure creane uno da qui"),
...
<table>
<thead><tr><th style="width:60%">{t("description")}</th><th style="width:25%">Dettaglio</th><th style="width:15%">Importo</th></tr></thead>
<tbody>${laborRows}</tbody>
</table>` : ''}
${(quote.partLines || []).length > 0 ? `
<div class="section-title">Materiali e Ricambi</div>
<table>
<thead><tr><th style="width:55%">{t("description")}</th><th style="width:30%">Q.tà × Prezzo</th><th style="width:15%">Importo</th></tr></thead>
...
const TABS = [
{ id: "overview", label: i18n.getLang() === "en" ? "Record" : "Scheda" },
{ id: "jobs", label: "Job (" + assetJobs.length + ")" },
{ id: "iec", label: "Sic. Elettrica (" + assetIec.length + ")" },
{ id: "func", label: "Funzionale (" + assetFunc.length + ")" },
{ id: "procs", label: (i18n.getLang() === "en" ? "Procedures" : "Procedure") + " (" + assetProcedures.length + ")" }
];
...
React.createElement("div", { style: LBL }, t("notes")),
asset.notes))),
...
React.createElement("div", null,
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", textTransform: "uppercase", letterSpacing: .8, fontWeight: 700, marginBottom: 8 } }, i18n.getLang() === "en" ? "Customer Portal Preview" : "Anteprima Portale Cliente"),
...
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", textTransform: "uppercase", letterSpacing: .8, fontWeight: 700, marginBottom: 8 } }, i18n.getLang() === "en" ? "Storage used" : "Spazio utilizzato"),
...
React.createElement(Btn, { variant: "ghost", onClick: () => downloadJSON("medtrace-backup-" + (new Date().toISOString().slice(0, 10)) + ".json", data) }, i18n.getLang() === "en" ? "⬇ Export backup" : "⬇ Esporta backup"),
React.createElement("label", null,
React.createElement("input", { type: "file", accept: ".json", onChange: fileRef, style: { display: "none" } }),
React.createElement("span", { style: { background: "#1E1E28", color: "#94a3b8", border: "1px solid #2a3040", borderRadius: 8, padding: "9px 16px", cursor: "pointer", fontSize: 13, fontWeight: 600, display: "inline-block" } }, i18n.getLang() === "en" ? "⬆ Import backup" : "⬆ Importa backup")),
...
pendingQuotes: quotes.filter(q => q.status === "bozza" || q.status === "inviato").length,
};
...
showToast("Fattura/ordine pagato");
};
const saveOrder = f => {
var _a;
...
showToast(i18n.getLang() === "en" ? "Test updated" : "Verifica aggiornata");
setModal(null);
return;
}
...
const esitoLabel = f.overallPass ? t("iec_pass") : t("iec_fail");
...
showToast(i18n.getLang() === "en" ? "Functional test updated" : "Verifica funzionale aggiornata");
setModal(null);
return;
}
const asset = assets.find(a => a.id === f.assetId) || {};
...
(newCounts.invoices ? "• " + newCounts.invoices + " nuovi preventivi/fatture legacy\n" : "") +
...
const exportAssets = () => downloadXLSX("medtrace_apparecchi.xlsx", assets.map(a => { var _a; return (Object.assign(Object.assign({}, a), { cliente: ((_a = customers.find(c => c.id === a.customerId)) === null || _a === void 0 ? void 0 : _a.name) || "" })); }), [{ key: "id", label: "ID" }, { key: "name", label: "Nome" }, { key: "brand", label: i18n.getLang() === "en" ? "Brand" : "Marca" }, { key: "model", label: i18n.getLang() === "en" ? "Model" : "Modello" }, { key: "serial", label: "N.Serie" }, { key: "location", label: i18n.getLang() === "en" ? "Location" : "Ubicazione" }, { key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente" }, { key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato" }, { key: "lastService", label: "Ultimo Serv." }, { key: "nextService", label: "Prossimo Serv." }, { key: "iecNorm", label: "Norma IEC" }, { key: "notes", label: "Note" }]);
const exportParts = () => downloadXLSX("medtrace_parti.xlsx", parts.map(p => (Object.assign(Object.assign({}, p), { compatibile: (p.compatible || []).map(id => { var _a; return ((_a = assets.find(a => a.id === id)) === null || _a === void 0 ? void 0 : _a.name) || id; }).join(", ") }))), [{ key: "id", label: "ID" }, { key: "code", label: i18n.getLang() === "en" ? "Code" : "Codice" }, { key: "name", label: "Nome" }, { key: "brand", label: i18n.getLang() === "en" ? "Brand" : "Marca" }, { key: "qty", label: "Q.tà" }, { key: "minQty", label: "Q.Min" }, { key: "unitPrice", label: "Costo" }, { key: "sellPrice", label: "Vendita" }, { key: "location", label: i18n.getLang() === "en" ? "Location" : "Ubicazione" }, { key: "compatibile", label: "Compatibile con" }, { key: "notes", label: "Note" }]);
...
}), [{ key: "id", label: "ID" }, { key: "apparecchio", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio" }, { key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente" }, { key: "type", label: i18n.getLang() === "en" ? "Type" : "Tipo" }, { key: "priority", label: i18n.getLang() === "en" ? "Priority" : "Priorità" }, { key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato" }, { key: "assignee", label: i18n.getLang() === "en" ? "Technician" : "Tecnico" }, { key: "openDate", label: i18n.getLang() === "en" ? "Opened" : "Apertura" }, { key: "closeDate", label: i18n.getLang() === "en" ? "Closed" : "Chiusura" }, { key: "description", label: "Descrizione" }, { key: "partiUsate", label: "Parti" }, { key: "laborHours", label: "Ore" }, { key: "laborRate", label: "Tariffa €/h" }, { key: "costoParti", label: "Costo Parti" }, { key: "costoManodopera", label: "Manodopera" }, { key: "totale", label: i18n.getLang() === "en" ? "Total" : "Totale" }]);
const exportOrders = () => downloadXLSX("medtrace_ordini.xlsx", orders.map(o => { var _a; return (Object.assign(Object.assign({}, o), { nomeParte: ((_a = parts.find(p => p.id === o.partId)) === null || _a === void 0 ? void 0 : _a.name) || o.partId, totale: (o.qty * o.unitPrice).toFixed(2) })); }), [{ key: "id", label: "ID" }, { key: "supplier", label: "Fornitore" }, { key: "nomeParte", label: "Parte" }, { key: "qty", label: "Q.tà" }, { key: "unitPrice", label: "Prezzo Unit." }, { key: "totale", label: i18n.getLang() === "en" ? "Total" : "Totale" }, { key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato" }, { key: "orderDate", label: "Data Ordine" }, { key: "expectedDate", label: "Consegna Prev." }, { key: "notes", label: "Note" }]);
const exportInvoices = () => downloadXLSX("medtrace_fatture.xlsx", invoices.map(i => { var _a; const sub = i.items.reduce((s, it) => s + it.qty * it.unitPrice, 0); const vat = i.items.reduce((s, it) => s + it.qty * it.unitPrice * it.vat / 100, 0); return Object.assign(Object.assign({}, i), { cliente: ((_a = customers.find(c => c.id === i.customerId)) === null || _a === void 0 ? void 0 : _a.name) || "", imponibile: sub.toFixed(2), iva: vat.toFixed(2), totale: (sub + vat).toFixed(2), items: undefined, jobIds: undefined }); }), [{ key: "number", label: i18n.getLang() === "en" ? "Quote No." : "N.Prev/Fatt" }, { key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente" }, { key: "date", label: i18n.getLang() === "en" ? "Date" : "Data" }, { key: "dueDate", label: "Scadenza" }, { key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato" }, { key: "imponibile", label: "Imponibile" }, { key: "iva", label: "IVA" }, { key: "totale", label: i18n.getLang() === "en" ? "Total" : "Totale" }, { key: "paymentTerms", label: "Pagamento" }, { key: "notes", label: "Note" }]);
const exportIecReports = () => downloadXLSX("medtrace_verifiche_IEC.csv", iecReports.map(r => { var _a; const a = assets.find(x => x.id === r.assetId) || {}; const c = customers.find(x => x.id === a.customerId) || {}; return Object.assign(Object.assign({}, r), { apparecchio: a.name || r.assetId || "", nSerie: a.serial || "", cliente: c.name || "", misure: ((_a = r.measures) === null || _a === void 0 ? void 0 : _a.map(m => m.name + ": " + m.value + m.unit + " (lim." + m.limit + ")").join("; ")) || "", measures: undefined, visual: undefined }); }), [{ key: "reportNumber", label: "N.Rapporto" }, { key: "date", label: i18n.getLang() === "en" ? "Date" : "Data" }, { key: "norm", label: i18n.getLang() === "en" ? "Standard" : "Norma" }, { key: "apparecchio", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio" }, { key: "nSerie", label: "N.Serie" }, { key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente" }, { key: "technician", label: i18n.getLang() === "en" ? "Technician" : "Tecnico" }, { key: "instrument", label: "Strumento" }, { key: "equipClass", label: "Classe" }, { key: "patientType", label: "Tipo Paziente" }, { key: "verifyType", label: "Tipo Verifica" }, { key: "overallPass", label: i18n.getLang() === "en" ? "Result" : "Esito" }, { key: "misure", label: "Misure" }, { key: "notes", label: "Note" }]);
const NAV_GROUPS = [
{
...
{
id: "g_maint", label: t("group_maintenance"),
...
items: [
{ id: "jobs", label: t("nav_jobs"), icon: "›", badge: stats.urgentJobs > 0 ? stats.urgentJobs : null, bColor: "#ef4444" },
{ id: "iec", label: t("nav_iec"), icon: "›" },
{ id: "func", label: t("nav_func"), icon: "›" },
{ id: "agenda", label: t("nav_agenda"), icon: "›", badge: upcomingMaintenance.filter(a => a.daysToService <= 7).length || null, bColor: "#f59e0b" },
{ id: "instruments", label: t("nav_instruments"), icon: "›", badge: instruments.filter(i => { const exp = i.calExpiry && new Date(i.calExpiry); return exp && Math.round((exp - new Date()) / 86400000) <= 60; }).length || null, bColor: "#f59e0b" },
{ id: "procedures", label: t("nav_procedures"), icon: "›" },
]
},
{
id: "g_assets", label: t("group_assets"),
groupIcon: React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "#2DD4BF", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" },
React.createElement("path", { d: "M19 21V5a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v16M3 21h18M9 7h6M9 11h6M9 15h6" })),
items: [
{ id: "assets", label: t("nav_assets"), icon: "›", badge: stats.outOfService > 0 ? stats.outOfService : null, bColor: "#ef4444" },
{ id: "customers", label: t("nav_customers"), icon: "›" },
]
},
{
id: "g_stock", label: t("group_warehouse"),
groupIcon: React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "#2DD4BF", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" },
...
{
id: "g_admin", label: t("group_admin"),
groupIcon: React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "#2DD4BF", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" },
React.createElement("line", { x1: "12", y1: "1", x2: "12", y2: "23" }),
React.createElement("path", { d: "M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" })),
items: [
{ id: "invoices", label: t("nav_quotes"), icon: "›", badge: stats.pendingQuotes > 0 ? stats.pendingQuotes : null, bColor: "#2DD4BF" },
]
},
{
id: "g_sys", label: t("group_system"),
groupIcon: React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "#2DD4BF", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" },
...
return (React.createElement("div", { key: lang, style: { minHeight: "100vh", background: "#0D0D12" } },
...
React.createElement("button", { onClick: () => { const nl = lang === 'it' ? 'en' : 'it'; i18n.setLang(nl); }, style: { background: "#1E1E28", border: "1px solid #2A2A38", color: "#94a3b8", cursor: "pointer", padding: "3px 9px", fontSize: 10, fontWeight: 800, borderRadius: 6 } }, lang === 'it' ? 'EN' : 'IT'),
...
!isMobile && React.createElement("h1", { style: { margin: "0 0 20px", fontSize: 20, fontWeight: 900 } }, t("dashboard_title")),
...
React.createElement(Btn, { variant: "ghost", onClick: () => { setTab("assets"); setModal({ type: "asset", data: null }); } }, i18n.getLang() === "en" ? "+ Add first equipment" : "+ Primo apparecchio")) })) : (React.createElement(React.Fragment, null,
React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 14 } },
React.createElement(Pill, { label: t("kpi_assets"), value: stats.totalAssets, onClick: () => setTab("assets") }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "In Use" : "Operativi", value: stats.operative, color: "#22c55e", onClick: () => setTab("assets") }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Maint." : "Manut.", value: stats.maintenance, color: "#f59e0b", onClick: () => setTab("assets") }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Condemned" : "Fuori serv.", value: stats.outOfService, color: "#ef4444", onClick: () => setTab("assets") })),
React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 14 } },
React.createElement(Pill, { label: t("kpi_open_jobs"), value: stats.openJobs, color: "#2DD4BF", onClick: () => setTab("jobs") }),
React.createElement(Pill, { label: t("kpi_urgent"), value: stats.urgentJobs, color: "#ef4444", onClick: () => setTab("jobs") }),
React.createElement(Pill, { label: t("kpi_quotes_open"), value: stats.pendingQuotes, color: "#2DD4BF", onClick: () => setTab('invoices') }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Customers" : "Clienti", value: stats.customers, color: "#a855f7", onClick: () => setTab("customers") })),
React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 14 } },
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Annual revenue" : "Ricavi anno", value: "€" + (financials.revenue / 1000).toFixed(1) + "k", color: "#22c55e", sub: String(filterYear), onClick: () => setTab("finance") }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Gross margin" : "Margine lordo", value: "€" + (financials.margin / 1000).toFixed(1) + "k", color: "#22c55e", onClick: () => setTab("finance") }),
React.createElement(Pill, { label: t("kpi_iec_reports"), value: iecReports.length, color: "#9955ff", onClick: () => setTab("iec") }),
React.createElement(Pill, { label: t("kpi_low_stock"), value: stats.lowStock, color: "#f59e0b", onClick: () => setTab('parts') }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Instruments expiring" : "Strumenti scaduti/in scad.", value: instruments.filter(i => { const exp = i.calExpiry && new Date(i.calExpiry); return exp && Math.round((exp - new Date()) / 86400000) <= 60; }).length, color: "#f59e0b", onClick: () => setTab("instruments") })),
React.createElement("div", { style: { display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 22 } },
React.createElement(Pill, { label: i18n.getLang() === "en" ? "% Jobs closed" : "% Job chiusi", value: jobs.length > 0 ? Math.round(jobs.filter(j => j.status === "chiuso").length / jobs.length * 100) + "%" : "—", color: "#22c55e", sub: "completion rate", onClick: () => setTab("jobs") }),
React.createElement(Pill, { label: t("kpi_out_of_service"), value: stats.outOfService, color: "#ef4444", sub: "apparecchi", onClick: () => setTab("assets") }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Warranties expiring" : "Garanzie in scad.", value: assets.filter(a => a.warrantyExpiry && Math.round((new Date(a.warrantyExpiry) - new Date()) / 86400000) < 90 && Math.round((new Date(a.warrantyExpiry) - new Date()) / 86400000) >= 0).length, color: "#f59e0b", sub: "entro 90gg", onClick: () => setTab("assets") }),
React.createElement(Pill, { label: i18n.getLang() === "en" ? "Scheduled" : "In pianificaz.", value: scheduleRows.filter(r => r.year === new Date().getFullYear()).length, color: "#2DD4BF", sub: "anno " + new Date().getFullYear() })),
...
{ key: "name", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio", render: v => React.createElement("strong", { style: { color: "#e2e8f0" } }, v) },
{ key: "brand", label: i18n.getLang() === "en" ? "Brand" : "Marca" },
{ key: "model", label: i18n.getLang() === "en" ? "Model" : "Modello" },
{ key: "serial", label: i18n.getLang() === "en" ? "Serial No." : "N. Serie", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11 } }, v || "—") },
{ key: "location", label: i18n.getLang() === "en" ? "Location" : "Ubicazione", opts: [...new Set(assets.map(a => a.location).filter(Boolean))] },
{ key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente", opts: [...new Set(assets.map(a => { var _a; return ((_a = customers.find(c => c.id === a.customerId)) === null || _a === void 0 ? void 0 : _a.name) || ""; }).filter(Boolean))] },
{ key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato", opts: ["operativo", "in manutenzione", "fuori servizio"],
...
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 } },
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 18, fontWeight: 900 } }, t("jobs_title")),
React.createElement("p", { style: { color: "#64748b", margin: "2px 0 0", fontSize: 12, fontFamily: "monospace" } },
...
{ key: "id", label: "ID", render: v => React.createElement("span", { style: { color: "#64748b", fontFamily: "monospace", fontSize: 11 } }, v) },
{ key: "apparecchio", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio", render: v => React.createElement("strong", { style: { color: "#e2e8f0" } }, v) },
{ key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente", opts: [...new Set(jobs.map(j => { var _a; const a = assets.find(x => x.id === j.assetId); return ((_a = customers.find(c => c.id === (j.customerId || (a === null || a === void 0 ? void 0 : a.customerId)))) === null || _a === void 0 ? void 0 : _a.name) || ""; }).filter(Boolean))] },
{ key: "type", label: i18n.getLang() === "en" ? "Type" : "Tipo", opts: ["correttiva", "preventiva", "verifica", "calibrazione"] },
{ key: "priority", label: i18n.getLang() === "en" ? "Priority" : "Priorità", opts: ["urgente", "alta", "normale", "bassa"],
render: v => React.createElement(Badge, { text: v, color: PRI_COLOR[v] || "#64748b" }) },
{ key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato", opts: ["aperto", "in corso", "chiuso"],
render: v => React.createElement(Badge, { text: v, color: STATUS_COLOR[v] || "#64748b" }) },
{ key: "assignee", label: i18n.getLang() === "en" ? "Technician" : "Tecnico" },
{ key: "openDate", label: i18n.getLang() === "en" ? "Opened" : "Apertura" },
{ key: "closeDate", label: i18n.getLang() === "en" ? "Closed" : "Chiusura", render: v => v || "—" },
...
{ key: "id", label: "ID", render: v => React.createElement("span", { style: { color: "#64748b", fontFamily: "monospace", fontSize: 11 } }, v) },
{ key: "code", label: i18n.getLang() === "en" ? "Code" : "Codice", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11 } }, v) },
{ key: "name", label: "Nome", render: v => React.createElement("strong", { style: { color: "#e2e8f0" } }, v) },
{ key: "brand", label: i18n.getLang() === "en" ? "Brand" : "Marca", opts: [...new Set(parts.map(p => p.brand).filter(Boolean))] },
{ key: "location", label: i18n.getLang() === "en" ? "Location" : "Ubicazione", opts: [...new Set(parts.map(p => p.location).filter(Boolean))] },
...
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 } },
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 18, fontWeight: 900 } }, t("customers_title")),
React.createElement("p", { style: { color: "#64748b", margin: "2px 0 0", fontSize: 12, fontFamily: "monospace" } },
customers.length,
" totali")),
...
{ key: "contact", label: i18n.getLang() === "en" ? "Contact" : "Referente" },
{ key: "email", label: "Email" },
{ key: "phone", label: i18n.getLang() === "en" ? "Phone" : "Telefono", render: v => React.createElement("span", { style: { fontFamily: "monospace" } }, v || "—") },
{ key: "address", label: "Indirizzo" },
{ key: "nApparecchi", label: t("nav_assets"), render: v => React.createElement("span", { style: { color: "#2DD4BF", fontWeight: 700 } }, v) },
...
i18n.getLang() === "en" ? "Quotes/Invoices" : "Preventivi/Fatture",
" (",
...
React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } },
React.createElement(Btn, { sm: true, onClick: () => setModal({ type: "func", data: null, assetId: null }) }, i18n.getLang() === "en" ? "+ New test" : "+ Nuova verifica"))),
...
React.createElement(Btn, { onClick: () => setModal({ type: "func", data: null, assetId: null }) }, i18n.getLang() === "en" ? "+ New test" : "+ Nuova verifica"))) : (React.createElement(ExcelTable, { defaultSort: "date", rowBg: row => row.overallPass === false || row.overallPass === "false" ? "#ef333308" : "", cols: [
{ key: "reportNumber", label: "N. Rapporto", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontWeight: 700 } }, v || "—") },
{ key: "date", label: i18n.getLang() === "en" ? "Date" : "Data" },
{ key: "tplLabel", label: "Tipo apparecchio", render: v => React.createElement("span", { style: { fontWeight: 700, color: "#e2e8f0" } }, v) },
{ key: "assetName", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio", render: v => React.createElement("span", { style: { color: "#94a3b8" } }, v) },
{ key: "serial", label: i18n.getLang() === "en" ? "Serial No." : "N. Serie", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11 } }, v || "—") },
{ key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente", opts: [...new Set(funcReports.map(r => { var _a; const a = assets.find(x => x.id === r.assetId); return ((_a = customers.find(c => c.id === (a === null || a === void 0 ? void 0 : a.customerId))) === null || _a === void 0 ? void 0 : _a.name) || ""; }).filter(Boolean))] },
{ key: "verifyType", label: i18n.getLang() === "en" ? "Type" : "Tipo", render: v => React.createElement("span", { style: { fontSize: 11, color: v === "straordinaria" ? "#f59e0b" : "#64748b" } }, v || "periodica") },
{ key: "technician", label: i18n.getLang() === "en" ? "Technician" : "Tecnico" },
{ key: "overallPass", label: i18n.getLang() === "en" ? "Result" : "Esito", render: v => React.createElement("span", { style: { fontWeight: 800, color: v === true || v === "true" ? "#22c55e" : "#ef4444" } }, v === true || v === "true" ? "✓ OK" : "✗ NO") },
...
React.createElement(Btn, { sm: true, onClick: () => setModal({ type: "iec", data: null, assetId: null }) }, i18n.getLang() === "en" ? "+ New test" : "+ Nuova verifica"))),
...
React.createElement(Btn, { onClick: () => setModal({ type: "iec", data: null, assetId: null }) }, i18n.getLang() === "en" ? "+ New test" : "+ Nuova verifica"))) : (React.createElement(ExcelTable, { defaultSort: "date", rowBg: row => row.overallPass === false || row.overallPass === "false" ? "#ef333308" : "", cols: [
{ key: "reportNumber", label: "N. Rapporto", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontWeight: 700 } }, v || "—") },
{ key: "date", label: i18n.getLang() === "en" ? "Date" : "Data" },
{ key: "apparecchio", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio", render: v => React.createElement("strong", { style: { color: "#e2e8f0" } }, v) },
{ key: "serial", label: i18n.getLang() === "en" ? "Serial No." : "N. Serie", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11 } }, v || "—") },
{ key: "cliente", label: i18n.getLang() === "en" ? "Customer" : "Cliente", opts: [...new Set(iecReports.map(r => { var _a; const a = assets.find(x => x.id === r.assetId); return ((_a = customers.find(c => c.id === (a === null || a === void 0 ? void 0 : a.customerId))) === null || _a === void 0 ? void 0 : _a.name) || ""; }).filter(Boolean))] },
{ key: "norm", label: i18n.getLang() === "en" ? "Standard" : "Norma", opts: ["62353", "61010"], render: v => React.createElement("span", { style: { fontSize: 11, color: "#64748b" } },
"IEC ",
v) },
{ key: "equipClass", label: "Classe" },
{ key: "verifyType", label: i18n.getLang() === "en" ? "Type" : "Tipo" },
{ key: "verifyType", label: i18n.getLang() === "en" ? "Type" : "Tipo", render: v => React.createElement("span", { style: { fontSize: 11, color: v === "straordinaria" ? "#f59e0b" : "#64748b" } }, v || "periodica") },
{ key: "technician", label: i18n.getLang() === "en" ? "Technician" : "Tecnico" },
{ key: "overallPass", label: i18n.getLang() === "en" ? "Result" : "Esito", render: v => React.createElement("span", { style: { fontWeight: 800, color: v === true || v === "true" ? "#22c55e" : "#ef4444" } }, v === true || v === "true" ? "✓ OK" : "✗ NO") },
{ key: "jobId", label: "Job", render: v => v ? React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11, color: "#5EEAD4" } }, v) : React.createElement("span", { style: { color: "#475569" } }, "\u2014") },
...
downloadXLSX("pianificazione-" + scheduleYear + ".csv", rows, [{ key: "month", label: "Mese" }, { key: "assetName", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio" }, { key: "brand", label: i18n.getLang() === "en" ? "Brand" : "Marca" }, { key: "serial", label: "N.Serie" }, { key: "location", label: i18n.getLang() === "en" ? "Location" : "Ubicazione" }, { key: "customer", label: i18n.getLang() === "en" ? "Customer" : "Cliente" }, { key: "norm", label: "Norma IEC" }, { key: "lastService", label: "Ultima verifica" }, { key: "nextService", label: "Data pianificata" }, { key: "status", label: "Stato apparecchio" }]);
...
{ key: "assetName", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio", render: v => React.createElement("strong", { style: { color: "#e2e8f0" } }, v) },
{ key: "brand", label: i18n.getLang() === "en" ? "Brand" : "Marca" },
{ key: "serial", label: i18n.getLang() === "en" ? "Serial No." : "N. Serie", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontSize: 11 } }, v || "—") },
{ key: "location", label: i18n.getLang() === "en" ? "Location" : "Ubicazione", opts: [...new Set(items.map(i => i.location).filter(Boolean))] },
{ key: "customer", label: i18n.getLang() === "en" ? "Customer" : "Cliente", opts: [...new Set(items.map(i => i.customer).filter(Boolean))] },
...
{ key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato", opts: ["operativo", "in manutenzione", "fuori servizio"], render: v => React.createElement(Badge, { text: v, color: STATUS_COLOR[v] || "#64748b" }) },
...
React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 10 } },
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 18, fontWeight: 900 } }, i18n.getLang() === "en" ? "Supplier Orders" : "Ordini Fornitori"),
...
"\u20AC",
parseFloat(v).toFixed(2)) },
{ key: "totale", label: i18n.getLang() === "en" ? "Total" : "Totale", render: v => React.createElement("span", { style: { fontFamily: "monospace", fontWeight: 700, color: "#a855f7" } },
"\u20AC",
v) },
{ key: "status", label: i18n.getLang() === "en" ? "Status" : "Stato", opts: ["in attesa", "confermato", "spedito", "ricevuto", "annullato"], render: v => React.createElement(Badge, { text: v, color: STATUS_COLOR[v] || "#94a3b8" }) },
...
{ key: "date", label: i18n.getLang() === "en" ? "Date" : "Data" },
{ key: "apparecchio", label: i18n.getLang() === "en" ? "Equipment" : "Apparecchio", render: v => React.createElement("strong", { style: { color: "#e2e8f0" } }, v) },
{ key: "tech", label: i18n.getLang() === "en" ? "Technician" : "Tecnico", render: v => v || "—" },
...
{ key: "total", label: i18n.getLang() === "en" ? "Total" : "Totale", render: v => React.createElement("span", { style: { color: "#22c55e", fontWeight: 800, fontFamily: "monospace" } },
"\u20AC",
parseFloat(v).toFixed(2)) },
...
return { number: newQuoteNumber(quotes), customerId: ((_b = modal.data) === null || _b === void 0 ? void 0 : _b.customerId) || (j === null || j === void 0 ? void 0 : j.customerId) || (a === null || a === void 0 ? void 0 : a.customerId) || "", jobId: ((_c = modal.data) === null || _c === void 0 ? void 0 : _c.jobId) || "", date: new Date().toISOString().slice(0, 10), validUntil: (() => { const d = new Date(); d.setDate(d.getDate() + 90); return d.toISOString().slice(0, 10); })(), status: "bozza", laborLines: lns, partLines: pns, paymentTerms: "Bonifico bancario a 30 giorni", notes: "", vatExempt: false };
...
React.createElement("button", { onClick: () => setPdfHtml(null), style: { background: "#1E1E28", color: "#94a3b8", border: "1px solid #2a3040", borderRadius: 7, padding: "7px 14px", cursor: "pointer", fontSize: 12, fontWeight: 700 } }, i18n.getLang() === "en" ? "✕ Close" : "✕ Chiudi"))),
